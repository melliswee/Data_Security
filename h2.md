...
For Authentication TAN (anything for start with and a "'" and ";", then the UPDATE that ends with ";" and then "--" to comment out rest there might be):
...
Which worked and John Smith has covered his tracks.
